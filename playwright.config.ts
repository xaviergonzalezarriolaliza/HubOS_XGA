...
export default defineConfig({
  // Include TypeScript and Python tests, but exclude helper folders so
  // Playwright doesn't treat page/lib modules as test files.
  testMatch: ['**/*.ts', '!tests/pages/**', '!tests/libs/**', '**/*.py'],
